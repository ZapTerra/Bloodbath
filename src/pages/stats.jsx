        ...
        <div id="stat-container">
            <div id="stat-list">
                ...
                <div className="stat">
                    ...
                    <p className="stat-info">{((globalStats?.totalBloodLost || 0)/1000).toLocaleString()}kL</p>
                </div>
                <div className="stat">
                    <h2 className="stat-name">Liters of blood departed:</h2>
                    <p className="stat-info">{(userStats?.bloodLost || 0).toLocaleString()}L</p>
                </div>
                <div className="stat">
                ...
                <div className="stat">
                    <h2 className="stat-name">Deaths:</h2>
                    <p className="stat-info">{(userStats?.deaths || 0).toLocaleString()}💀</p>
                </div>
                <div className="stat">
